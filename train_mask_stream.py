...
def test_model(epoch):
    ...
    if ACCURACY < final_acc:
        ...
        torch.save(model.state_dict(), f"model_checkpoints/{model.__class__.__name__}_{epoch}for_mask_channel_IM_224_best_{final_acc}(full_data).pth")
    ...
    plt.savefig(f"score{epoch}for_mask_channel_with_accuracy{final_acc}.png")
