...
def test_model(epoch):
    ...
    if ACCURACY < final_acc:
        ...
        torch.save(model.state_dict(), f"model_checkpoints/optical_flow_64_{epoch}_best_{final_acc}.pth")
    ...
    plt.savefig(f"confusion_matrix/epoch={epoch}_optical_flow_64_acc={final_acc}.png")
